...
/// <summary>
/// Scriptable object for controlling tutorial enemy aggressive state.
/// </summary>
[CreateAssetMenu(fileName = "Enemy Tutorial Aggressive State")]
public class EnemyTutorialAgressiveState : EnemyTutorialAbstractState
{
